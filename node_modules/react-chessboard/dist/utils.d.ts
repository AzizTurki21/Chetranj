import type { SquareDataType, PositionDataType } from './types.js';
...
export declare function getPromotionUpdates(oldPosition: PositionDataType, newPosition: PositionDataType, noOfRows: number, noOfColumns: number): {
    [square: string]: string;
};
/**
